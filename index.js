...
function startStream(filePath, streamKey) {
    const ffmpegCommand = `ffmpeg -re -stream_loop -1 -i ${filePath} -vcodec libx264 -preset veryfast -crf 25 -c:a aac -b:a 96k -ar 44100 -maxrate 300k -bufsize 600k -g 60 -r 15 -s 240x426 -f flv "rtmp://a.rtmp.youtube.com/live2/${streamKey}"`;
